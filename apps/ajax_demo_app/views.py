...
def index(request):
    return render(request, 'ajax_demo_app/index.html')
...
def find(request):
    return render(request, 'ajax_demo_app/all.html',
...
def create(request):
    ...
    return render(request, 'ajax_demo_app/all.html',{ "users": User.objects.order_by("-id") })